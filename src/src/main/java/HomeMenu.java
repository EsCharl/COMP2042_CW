...
public class HomeMenu extends JComponent implements MouseListener, MouseMotionListener {
    ...
    // for the images
    private static final String MAIN_IMAGE_PATH = "src/main/java/Resources/mainimage.png";
    private static final String INFO_IMAGE_PATH = "src/main/java/Resources/Info.png";
